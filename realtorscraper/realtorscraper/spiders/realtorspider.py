...
import json
    ...
    # Data being pulled from site, pages in range 1-17, this can be changed to numbers avaliable
class RealtorSpider(scrapy.Spider):
    name = "realtorspider"
    start_urls = [f"https://www.realtor.com/realestateandhomes-search/Madison_WI/pg-{page}"
    ...
    def parse(self, response):
        ...
        for home in homes:
            home_data = {
                ...
                "Home State": home["location"]["address"].get("state", None),
